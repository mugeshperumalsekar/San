...
public class FuzzyRatioSimilarity {
...
//                sim[i][j] = (double) Math.round(fuzzysearch.weightedRatio(t1, t2));
                sim[i][j] = (double) Math.round(fuzzysearch.ratio(t1, t2) );
            }
        });
...
//        double matchingper2 = (double) Math.round(fuzzysearch.weightedRatio(name1, name2));
        double matchingper2 = (double) Math.round(fuzzysearch.ratio(name1,name2) );
