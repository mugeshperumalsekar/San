...
@Service
public class UkSanUkSanEntityClassGeneratorImpl implements UkSanEntityClassGenerator {
    ...
    public ResponseEntity<String> generateEntityClass(String className, String tableName, List<String> columns) {
        ...
        classContent.append("package com.ponsun.san.ukSan.entity;\n\n");
        ...
        classContent.append("}\n");
        String entityPath = "src\\main\\java\\com\\ponsun\\san\\excelimport\\entity";
