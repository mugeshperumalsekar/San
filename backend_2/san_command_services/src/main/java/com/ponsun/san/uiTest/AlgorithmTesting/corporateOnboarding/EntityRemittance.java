...
public class EntityRemittance {
    public static double[]  EntityRemittanceMatches(String name1,String name2,String id1,String id2,String country1,String country2) throws Exception {
