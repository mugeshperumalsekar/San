...
const Sidebar = () => {
  ...
  const handleSanAlert = () => {
    navigate('/SanAlert');
  };

  const handleXmlUploader = () => {
    navigate('/XmlUploader');
  };
      ...
      case '/XmlUploader':
        return (
          <List>
            ...
            {/* <ListItemButton sx={{ height: '40px' }} onClick={handleSanAlert}>
              <ListItemIcon
                sx={{
                  minWidth: 0,
                  mr: open ? 2 : 'auto',
              ...
              >
                <Tooltip title="Alert" placement="right" arrow>
                  <AssignmentIcon />
                </Tooltip>
              </ListItemIcon>
              <ListItemText primary="Alert" sx={{ opacity: open ? 1 : 0 }}
                className={`custom-list-item-text ${open ? 'custom-list-item-text-open' : 'custom-list-item-text-closed'}`} />
            </ListItemButton> */}

            <ListItemButton sx={{ height: '40px' }} onClick={handleXmlUploader}>
              <ListItemIcon
                sx={{
                  minWidth: 0,
                  mr: open ? 2 : 'auto',
              ...
              >
                <Tooltip title="XmlUploader" placement="right" arrow>
                  <AssignmentIcon />
                </Tooltip>
              </ListItemIcon>
              <ListItemText primary="XmlUploader" sx={{ opacity: open ? 1 : 0 }}
                className={`custom-list-item-text ${open ? 'custom-list-item-text-open' : 'custom-list-item-text-closed'}`} />
            </ListItemButton>
